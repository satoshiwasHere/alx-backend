...
def get_user() -> Union[Dict, None]:
    """
    Returns a user dictionary or Null if ID value can't be found
    """
...
def get_locale():
    """
    Select, match and return best language based on supported languages
    """
...
def get_timezone():
    """Pick & return appropriate timezone
    """
